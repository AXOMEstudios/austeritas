...
def load_list():
    global l
    with open(path.join("src", "global_bans", LIST_NAME), "r") as f:
        l = load(f)
...
def check_for_update():
    ...
    with open(path.join("src", "global_bans", LIST_CHECKSUM_NAME), "r") as f:
...
def run_update():
    ...
    with open(path.join("src", "global_bans", LIST_NAME), "w") as f:
        dump(new_list, f, indent=4)

    with open(path.join("src", "global_bans", LIST_CHECKSUM_NAME), "w") as f:
