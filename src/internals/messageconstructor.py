...
BAN_MESSAGE = f'''{c.red}[Austeritas]{c.reset + c.bold + c.warning} 
You have been banned from %s.{c.reset} 
Duration: {c.red}%s {c.reset} 
[You can re-join upon the end of your ban]'''

BAN_MESSAGE_CHAT = f'''{c.red}[Austeritas]{c.reset}: {c.warning}@%s has been banned (duration: %s).'''
